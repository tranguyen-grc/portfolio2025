      ...
      <section className="py-10 flex flex-col gap-[4.5rem]">
        ...
        <TwoColumnSection title="Overview">
          <div className="flex flex-col gap-[1.5rem]">
            <p className="text-rg-sm-normal text-black">
              The Sustainable Land Initiative (SLI) supports farmers in adopting
              climate-smart practices. As part of a broader website update, I
              led the redesign of the Farmshare platform—a new tool that enables
              farmers to rent agricultural equipment directly through the site.
            </p>
            <p className="text-rg-sm-normal text-black">
              In addition to designing Farmshare, I created a reusable design
              system, redesigned several outdated pages, and improved the admin
              dashboard for internal management.
            </p>
          </div>
        </TwoColumnSection>
        ...
        <TwoColumnSection title="Design System">
          <div className="flex flex-col gap-[1.5rem] text-rg-sm-normal text-black">
            ...
            <p>
              This system now serves as the foundation for current and upcoming
              web projects.
            </p>
          </div>
        </TwoColumnSection>
          ...
          <div className="flex flex-col gap-[1.5rem] text-rg-sm-normal text-black">
            ...
            <div className="flex flex-col gap-[1rem]">
              ...
              <p>
                ...
                admin experience, making it easier for internal users to manage
                equipment, users, and reservations.
              </p>
            </div>
          </div>
        </TwoColumnSection>
          ...
          <div className="flex flex-col gap-[1.5rem] text-rg-sm-normal text-black">
            ...
            <div className="flex flex-col gap-[1rem]">
              ...
              <p>
                ...
                grouped feedback into themes, surfaced pain points, and iterated
                solutions. Insights led to:
              </p>
              <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              ...
              />
              <p>
                During usability interviews, several users expressed interest in
                a rating and review system to help assess equipment condition
                and reliability. I explored how this feature could fit into the
                reservation flow and presented an early concept.
              </p>
              <ImageLightbox
                src={Reviews}
              ...
              <p>
                ...
                to defer this feature due to scope limitations and unclear value
                at this stage. This experience reinforced the importance of
                balancing user needs with technical and strategic constraints.
              </p>
            </div>
          </div>
        </TwoColumnSection>
        ...
        <TwoColumnSection title="Takeaways">
          <div className="flex flex-col gap-[1rem] text-rg-sm-normal text-black">
            ...
            <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              ...
              visual consistency but also helped our team move faster and laid a
              solid foundation for future SLI products.
            </div>
            <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              I conducted user interviews for every feature to test and iterate
              on my designs. When users requested a rating system for FarmShare,
              I explored the idea—but after reviewing with the product owner, we
              decided to defer it due to scope and priorities. This reinforced
              that good UX balances user needs with technical and business
              constraints.
            </div>
            <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              The fixed information architecture was limiting, but it pushed me
              to find a workaround using a secondary navigation bar—a solution
              that turned out to be both effective and intuitive.
            </div>
            <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
            ...
            <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              Working in Agile sprints kept the design and dev team aligned. It
              allowed me to test features with users, make rapid changes, and
              hand off components efficiently with continuous feedback.
            </div>
          </div>
        </TwoColumnSection>
