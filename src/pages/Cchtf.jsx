      ...
      <section className="py-10 flex flex-col gap-[4.5rem]">
        ...
        <div data-aos="fade-up" data-aos-delay="300">
          <TwoColumnSection title="Overview">
            <p className="text-rg-sm-normal text-black">
              ...
              for Central Coast Tree Heritage, a nonprofit organization focused
              on preserving and tracking regional tree data. Our goal was to
              create a functional, intuitive interface for two user
              types—volunteers and administrators—with clearly differentiated
              access and tasks. This was the organization's first digital
              platform, so we designed the portal from the ground up, including
              a fully customized design system.
            </p>
          </TwoColumnSection>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="400">
          <TwoColumnSection title="Problem">
            <p className="text-rg-sm-normal text-black">
              ...
              that would allow volunteers to log tree data in the field and
              admins to manage and analyze contributions effectively.
            </p>
          </TwoColumnSection>
        </div>
            ...
            <div className="flex flex-col gap-[1.5rem] text-rg-sm-normal text-black">
              <div className="flex flex-col gap-[1rem]">
                <p>
                  ...
                  their own contributions and simplified navigation, while
                  admins required broader visibility and management tools.
                  Together, we mapped out user flows for each role to guide the
                  interface structure.
                </p>
                <ImageLightbox
                  src={userFlow}
        ...
        <div data-aos="fade-up" data-aos-delay="800">
          <TwoColumnSection title="Collaboration with Developers">
            <p className="text-rg-sm-normal text-black">
              ...
              functionality and prioritize must-have features within the
              available timeline.
            </p>
          </TwoColumnSection>
        </div>
        ...
        <div data-aos="fade-up" data-aos-delay="900">
          <TwoColumnSection title="My Role">
            <p className="text-rg-sm-normal text-black">
              I focused on designing the Tree Inventory tables, User Profile
              page, Volunteer Directory, and the Sign In/Sign Up experience. I
              also led the design for the mobile adaptation, including visual
              cues to guide user behavior around device orientation and feature
              availability.
            </p>
          </TwoColumnSection>
        </div>
            ...
            <div className="flex flex-col gap-[1.5rem] text-rg-sm-normal text-black">
              ...
              <div className="flex flex-col gap-[1rem]">
                <p>
                  ...
                  version, I began exploring how role switching might work. On
                  the left-hand option, I placed a card containing the username
                  and current role in the navigation bar, with a dropdown for
              ...
              <div className="flex flex-col gap-[1rem]">
                <p>
                  ...
                  stakeholder feedback and continued progressing other pages,
                  such as viewing and editing profile information and the
              ...
              <div className="flex flex-col gap-[1rem]">
                <p>
                  ...
                  <span className="text-rg-sm-medium">high-fidelity</span>{" "}
                  stage, reworking spacing and applying consistent components
                  from our design system throughout the platform. Here are two
                  example user stories we built upon:
                </p>
                <p>
                ...
                />
                <p>
                  As an admin, I want to be able to create and delete messages
                  in order to communicate with volunteers.
                </p>
                <ImageLightbox
                  src={Msg}
                ...
                />
                <p>
                  We also created a mobile view of the portal. Since the tree
                  and volunteer tables were too large to view comfortably on
                  smaller screens, I created custom illustrations to inform
                  users that the Volunteer Directory and Tree Inventory pages
                  are only accessible on desktop, and that they should rotate
                  their phone to portrait orientation where applicable.
                </p>
                <ImageLightbox
                  src={Mobile}
                  alt="Mobile view."
        ...
        <div data-aos="fade-up" data-aos-delay="1100">
          <TwoColumnSection title="Outcome">
            <div className="flex flex-col gap-[1rem] text-rg-sm-normal text-black">
              ...
              <p>
                The portal enables volunteers to log and track their
                contributions while giving admins full visibility into the
                organization's growing tree inventory. Our collaboration
                improved efficiency, transparency, and scalability for Central
                Coast Tree Heritage Foundation's mission.
              </p>
            </div>
          </TwoColumnSection>
          ...
          <TwoColumnSection title="Takeaways">
            <div className="flex flex-col gap-[1rem] text-rg-sm-normal text-black">
              <p>What I learned:</p>
              <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
                Designing by user story made developer handoff more intuitive
                and efficient.
              </div>
              <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
                Clear communication between design, PM, and development teams
                was crucial to staying within scope and delivering meaningful
                features.
              </div>
              <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
              ...
              <div className="px-4 py-3 rounded-[0.75rem] bg-gray30">
                Providing thoughtful mobile accommodations and clear UX
                messaging helped maintain usability across devices.
              </div>
            </div>
          </TwoColumnSection>
        </div>
